...
import { Carteproduit, Listeproduits,Carteproduit2, Seller} from './Components/Carteproduit'
  ...
  return (
    <div className="App">
      ...
      <Navigation/>
       ...
       <Carteproduit src={images.at(-1).src} auteur={images.at(-1).auteur} montant={images.at(-1).montant} profil={images.at(-1).profil} description={images.at(-1).description} />
       <Carteproduit src={images.at(-2).src} auteur={images.at(-2).auteur} montant={images.at(-2).montant} profil={images.at(-2).profil} description={images.at(-2).description} />
      ...
      <Modal/>
      <Entete titre={'MODAL2 '} />
      <Modal2 src={images.at(-1).src} auteur={images.at(-1).auteur} montant={images.at(-1).montant} profil={images.at(-1).profil} description={images.at(-1).description}/>
      <Entete titre={'FIN  '} />
